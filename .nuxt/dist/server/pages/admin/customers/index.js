...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/admin/customers/index.vue?vue&type=template&id=2f32087f&scoped=true&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('page-title',{attrs:{"title_text":"مشتریان","icon":"customer"}}),_vm._ssrNode(" "),(_vm.customers)?_vm._ssrNode("<div class=\"bg-white shadow-sm py-3 my-2\" style=\"border-radius: 10px;\" data-v-2f32087f>","</div>",[_vm._ssrNode("<div class=\"px-3\" data-v-2f32087f>","</div>",[_vm._ssrNode("<div class=\"table-responsive\" data-v-2f32087f>","</div>",[_vm._ssrNode("<table class=\"table  table-responsive table-borderless text-center\" data-v-2f32087f>","</table>",[_vm._ssrNode("<thead data-v-2f32087f><tr data-v-2f32087f><th scope=\"col\" style=\"background-color: #eee;  border-radius: 0 16px 16px 0;\" data-v-2f32087f>#</th> <th scope=\"col\" style=\"background-color: #eee;\" data-v-2f32087f>نام</th> <th scope=\"col\" style=\"background-color: #eee;\" data-v-2f32087f>نوع</th> <th scope=\"col\" style=\"background-color: #eee;\" data-v-2f32087f>تلفن</th> <th scope=\"col\" style=\"background-color: #eee;\" data-v-2f32087f>وضعیت</th> <th scope=\"col\" style=\"background-color: #eee;border-radius: 16px 0px 0px 16px;\" data-v-2f32087f>جزییات</th></tr></thead> "),_vm._ssrNode("<tbody data-v-2f32087f>","</tbody>",_vm._l((_vm.customers.data),function(customer,index){return _vm._ssrNode("<tr data-v-2f32087f>","</tr>",[_vm._ssrNode("<td data-v-2f32087f>"+_vm._ssrEscape(_vm._s(customer.id))+"</td> <td data-v-2f32087f>"+_vm._ssrEscape(_vm._s(customer.first_name))+"</td> <td data-v-2f32087f>"+_vm._ssrEscape(_vm._s(customer.last_name))+"</td> <td data-v-2f32087f>"+_vm._ssrEscape(_vm._s(customer.phone))+"</td> "),_vm._ssrNode("<td data-v-2f32087f>","</td>",[_c('b-badge',{attrs:{"variant":_vm.CustomerStatus.getStatus(customer.status).variant}},[_vm._v(_vm._s(_vm.CustomerStatus.getStatus(customer.status).text))])],1),_vm._ssrNode(" "),_vm._ssrNode("<td data-v-2f32087f>","</td>",[_c('router-link',{staticClass:"btn btn-primary",attrs:{"to":'/admin/customers/' + customer.id + '/find'}},[_vm._v("جزییات")])],1)],2)}),0)],2)])]),_vm._ssrNode(" "+((_vm.customers.next_page_url || _vm.customers.prev_page_url)?("<hr data-v-2f32087f>"):"<!---->")+" "),_c('pagination',{attrs:{"data":_vm.customers,"get_data":_vm.get_data,"perpage":_vm.per_page}})],2):_vm._e()],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/admin/customers/index.vue?vue&type=template&id=2f32087f&scoped=true&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/admin/customers/index.vue?vue&type=script&lang=js&
//
//
//
//
...
//
//
/* harmony default export */ var customersvue_type_script_lang_js_ = ({name:"index",components:{PageTitle: pageTitle["default"]},layout:"main-content",data(){return{CustomerStatus: CustomerStatus["a" /* default */],customers:null,per_page:15};},methods:{async get_data(url){let res=await api["a" /* default */].get(url+'&perpage='+this.per_page);this.customers=res.data.data;}},async created(){let res=await api["a" /* default */].get('customer/all'+'?perpage='+this.per_page);this.customers=res.data.data;}});
// CONCATENATED MODULE: ./pages/admin/customers/index.vue?vue&type=script&lang=js&
 /* harmony default export */ var admin_customersvue_type_script_lang_js_ = (customersvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(1);

// CONCATENATED MODULE: ./pages/admin/customers/index.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  admin_customersvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  injectStyles,
