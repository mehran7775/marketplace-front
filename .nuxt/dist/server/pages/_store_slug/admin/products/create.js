...
module.exports.__inject__ = function (context) {
  add("6e067bbe", content, true, context)
};
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/_store_slug/admin/products/create.vue?vue&type=script&lang=js&
//
//
//
//
...
//
//
/* harmony default export */ var createvue_type_script_lang_js_ = ({name:"create",components:{PageTitle: pageTitle["default"]},layout:"main-content",data(){return{formData:{title:null,store_id:this.$route.params.store_slug,price:0,unlimited:false,is_multiple:false,quantity:0,discount_amount:0,discount_percent:0,discount_max_amount:0,image:null,description:null}};},methods:{createProduct(){let form_data=new FormData();for(let key in this.formData){if(this.formData[key]===true||this.formData[key]===false){if(this.formData[key]===true){form_data.append(key,1);}if(this.formData[key]===false){form_data.append(key,0);}}else{if(this.formData[key]!==null){form_data.append(key,this.formData[key]);}}}if(this.formData.image){form_data.append('images[0]',this.formData.image);}api["a" /* default */].post('product/create',form_data,this.$cookies.get('token')).then(response=>{alert(response.data.message);}).catch(({response})=>{alert(response.data.data[Object.keys(response.data.data)[0]]);});}}});
// CONCATENATED MODULE: ./pages/_store_slug/admin/products/create.vue?vue&type=script&lang=js&
 /* harmony default export */ var products_createvue_type_script_lang_js_ = (createvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(1);

// CONCATENATED MODULE: ./pages/_store_slug/admin/products/create.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  products_createvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  injectStyles,
