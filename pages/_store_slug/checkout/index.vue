                ...
                <div class="col-11 mx-auto pb-5">
                    <div class="row">
                        <div id="checkout" class="mx-auto">
                            ...
                            <div v-if="gateways.length > 1" class="col-12 mt-5"> 
                                <div class="row">
                                    <h2 class="font-weight-bold h6">انتخاب روش پرداخت</h2>
                                </div>
                                    <div class="row">
                                        <div  v-for="gateway in gateways" :key="gateway.id" class="col-12 mt-1">
                                        <div class="row">
                                                <div class="getways">
                                                <input
                                                    class="mr-4"
...
export default {
    ...
    methods:{
        ...
        //             gateway_id: this.gateways[0].id
        //         });
        //     }else{
        //         $nuxt.$bvModal.show('select-getways')
        //     }
        // },
