      ...
      <header class="d-flex flex-column-reverse align-items-center d-md-flex flex-md-row">
        <div class="d-flex flex-row align-items-center justify-content-between" id="brand_index">
          ...
          <div class="d-flex align-items-center flex-wrap">
            ...
            <a v-if="detail.social_page.whatsapp" :href="detail.social_page.whatsapp ? detail.social_page.whatsapp: '#'" class="mx-2" v-b-tooltip.hover.top title="واتساپ"
              target="_blank" rel="noopener noreferrer"
            >
              <fa :icon="['fab','whatsapp']" class="fa-lg"></fa>
            </a>
            <a v-if="detail.social_page.telegram" :href="detail.social_page.telegram ? detail.social_page.telegram: '#'" class="mx-2" v-b-tooltip.hover.top title="تلگرام"
            target="_blank" rel="noopener noreferrer"
            >
              <fa :icon="['fab','telegram']" class="fa-lg"></fa>
            </a>
            <a v-if="detail.social_page.aparat" :href="detail.social_page.aparat ? detail.social_page.aparat: '#'" class="mx-2"  v-b-tooltip.hover.top title="آپارات"
            target="_blank" rel="noopener noreferrer"
            >
